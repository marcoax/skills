...
| `message-log-analizer` | `skills/message-log-analizer` | Analyzes Carimali MQTT message logs and generates traffic trend reports. |
...
| `recipe-analizer` | `skills/recipe-analizer` | Analyzes machine recipes by sub-product type and generates attribute frequency statistics. |
